...
for (row in 1:nrow(sig_comp[[1]])) {
  # print(row)
  rt1 <- c(rt1, new_df[which(new_df$Feature == as.numeric(sig_comp[[1]][row,]$Feature)),]$RT1)
  rt2 <- c(rt2,new_df[which(new_df$Feature == as.numeric(sig_comp[[1]][row,]$Feature)),]$RT2)
  major <- c(major, new_df[which(new_df$Feature == as.numeric(sig_comp[[1]][row,]$Feature)),]$Ion1)
  minor <- c(minor, new_df[which(new_df$Feature == as.numeric(sig_comp[[1]][row,]$Feature)),]$Ion2)
  chem_grp <- c(chem_grp, new_df[which(new_df$Feature == as.numeric(sig_comp[[1]][row,]$Feature)),]$Chemical_group)
}
